...
function SocialLinks() {
  return (
    <div className="flex gap-32 items-center ">
      <span className='headingsh5medium'>Follow us:</span>
      {socialLinks.map(link => (
        <div className='flex w-24 h-24 justify-center items-center'><a key={link.id} href="#" aria-label={`Follow us on ${link.alt}`}>
